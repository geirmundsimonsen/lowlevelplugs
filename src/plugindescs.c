...
extern clap_plugin_t* p000_create(const clap_plugin_descriptor_t*, const clap_host_t* host);extern clap_plugin_t* p001_create(const clap_plugin_descriptor_t*, const clap_host_t* host);extern clap_plugin_t* p002_create(const clap_plugin_descriptor_t*, const clap_host_t* host);extern clap_plugin_t* p005_create(const clap_plugin_descriptor_t*, const clap_host_t* host);

plugin_t plugins[] = {
{ { CLAP_VERSION_INIT, "com.nevrofon.p000", "p000 - Sine test -18db", "Nevrofon", "", "", "", "", "",  instrument_stereo }, p000_create },{ { CLAP_VERSION_INIT, "com.nevrofon.p001", "p001 - Noise test -18db", "Nevrofon", "", "", "", "", "",  instrument_stereo }, p001_create },{ { CLAP_VERSION_INIT, "com.nevrofon.p002", "p002 - Saw test -18db", "Nevrofon", "", "", "", "", "",  instrument_stereo }, p002_create },{ { CLAP_VERSION_INIT, "com.nevrofon.p005", "p005 - test", "Nevrofon", "", "", "", "", "",  instrument_stereo }, p005_create },
};
